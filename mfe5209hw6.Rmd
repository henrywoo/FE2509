---
title: "MFE5209HW6 - Value At Risk"
author: "Wu Fuheng"
...
R(P_1+P_2)
&= VaR(P_1+P_2)\\
&= S_1 + S_2 + \sqrt{ \sigma_{1}^2 + \sigma_{2}^2 + 2\rho\sigma_1 \sigma_2}  \sqrt{2} erf^{-1}(2p-1)\\
\end{align*}$$
...
R(P_1)+R(P_2)
&= VaR(P_1)+VaR(P_2)\\
&= S_1 + \sigma_1  \sqrt{2} erf^{-1}(2p-1) + S_2 + \sigma_2  \sqrt{2} erf^{-1}(2p-1)\\
&= S_1 + S_2 + (\sigma_1 + \sigma_2)  \sqrt{2} erf^{-1}(2p-1)\\
&= S_1 + S_2 + \sqrt{ \sigma_{1}^2 + \sigma_{2}^2 + 2\sigma_1 \sigma_2}  \sqrt{2} erf^{-1}(2p-1)\\
\end{align*}$$
...
Reference Link: [Sum of normally distributed random variables](http://en.wikipedia.org/wiki/Sum_of_normally_distributed_random_variables)
